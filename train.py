...
if __name__ == '__main__':
    ...
    if args.opt == 'SGD': 
        ...
        opt = SAM(params, base_opt,lr=args.max_lr, momentum=0.9, weight_decay=5e-4)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model, f'models/{dataset}_{args.opt}{"_adv" if args.adv else ""}.pth')
